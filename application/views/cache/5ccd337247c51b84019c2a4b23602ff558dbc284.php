      ...
      <div class="col-lg-8 col-xl-6">
        <div class="card rounded-3">
          ...
          <div class="card-body p-4 p-md-5">
            <h3 class="mb-4 pb-2 pb-md-0 mb-md-5 px-md-2">Change Photo Cat Form</h3>
            ...
            <form class="px-md-2" action="" method="post" enctype="multipart/form-data">
              ...
              <img src="<?=base_url('uploads/cats/'.$cat->catphoto_082)?>" alt="" width="128" height="128">
              </div>
              ...
              <input type="submit" name="upload" class="btn btn-primary btn-lg mb-1" value="Upload">
...
<?php echo $__env->make('layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\catshop082-ci\application\views/cats/form_photocat.blade.php ENDPATH**/ ?>